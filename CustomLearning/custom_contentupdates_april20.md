...
##### <a name="work-remotely-5-new-assets"></a>Lavorare in remoto (5 nuovi asset)
...
#### <a name="start-chats-and-calls-2-new1-updated"></a>Avviare chat e chiamate (2 nuovo/1 aggiornato)
- Avviare e aggiungere chat (nuovo)
- Nascondere le chat, eliminare i messaggi (nuovo)
- Effettuare chiamate (aggiornate)
#### <a name="explore-apps-and-tools-1-new"></a>Esplorare app e strumenti (1 nuovo)
- Usare le app (nuove)
...
#### <a name="forms-4-new-assets"></a>Moduli (4 nuovi asset) 
- Creare un modulo 
